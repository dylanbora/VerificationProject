...
public class ScottDylanTestTask3 {
    ...
    @org.junit.jupiter.api.Test // Test to check normal rate for staff.
    ...
    public void testEighteen(){
        ...
        BigDecimal correctVal = BigDecimal.valueOf(0);
        calc = rate.calculate(periodStay.get(0));
        int returnOF = calc.compareTo(correctVal);
        assertEquals(0, returnOF, "Expected: (" + correctVal + ") Actual: (" + calc + ")");
    ...
    @org.junit.jupiter.api.Test // Test to check rate for staff without discount.
